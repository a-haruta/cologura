...
import { IMeshSource, Vertex } from "./mesh";

export class ObjMeshSource implements IMeshSource {
    vertices: Vertex[];
    indices: number[];

    public static async load(url: string): Promise<ObjMeshSource> {
        ...
        return new ObjMeshSource(vertices, indices);
    }

    private constructor(vertices: Vertex[], indices: number[]) {
